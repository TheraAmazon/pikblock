...
pragma solidity 0.7.3 <0.8.6;

/**
     * Thera.Foundation Emerald Smart Contract Multiple Stable Amazon tainforest Coin
     */
...
//12
contract TheraPreSale is TheraFounding {
...
contract TheraSpecial is TheraFounding {
    uint256 internal constant RATE = 69060000000000000;
    
    constructor(address payable Wallet, address payable Token) public Crowdsale(RATE, Wallet, TheraSeeding(Token)) {
    }
}
//16
contract TheraExtraordinary is TheraFounding {
    uint256 internal constant RATE = 59060000000000000;
    
    constructor(address payable Wallet, address payable Token) public Crowdsale(RATE, Wallet, TheraSeeding(Token)) {
    }
}
//20
contract TheraEccentric is TheraFounding {
    uint256 internal constant RATE = 49060000000000000;
