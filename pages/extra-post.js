...
export default function CreateItem() {
  ...
  async function createSale(url) {
    ...
    let contract = new ethers.Contract(pikblockextraaddress, PIKBLOCKEXTRA.abi, signer)
    ...
    contract = new ethers.Contract(pikblockextraMarketaddress, PIKBLOCKEXTRAMarket.abi, signer)
    let listingPrice = await contract.getListingPrice()
    listingPrice = listingPrice.toString()

    transaction = await contract.createMarketItem(pikblockextraaddress, tokenId, price, { value: listingPrice })
    ...
    <div className="flex justify-center">
      ...
      <p className="text-1xl italic">For the safety of your copyright work and best practices
       ...
       <Link href="https://www.gimlu.com/faucet">
        ...
        <button onClick={createMarket} className="font-bold mt-4 bg-yellow-400 text-white rounded p-4 shadow-lg">
          Create Post 
        </button>
      </div>
    </div>
