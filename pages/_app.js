    ...
    <div className="min-h-full bg-gray-100 py-4 flex flex-col justify-center sm:py-12">
       ...
       <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/">
            <a className="text-2xl mr-2 text-red-400">
            Pikblock
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/event">
            <a className="text-2xl mr-2 text-yellow-600">
            Event Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/extra">
            <a className="text-2xl mr-2 text-yellow-400">
            Extra Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/family">
            <a className="text-2xl mr-2 text-green-500">
            Family Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/friends">
            <a className="text-2xl mr-2 text-blue-400">
            Friends Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/lifestyle">
            <a className="text-2xl mr-2 text-blue-600">
            Lifestyle Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/portrait">
            <a className="text-2xl mr-2 text-purple-600">
            Portrait Piks
            </a>
          </Link>
        </div>
      ...
      <nav className="border-b p-2 mt-2 flex justify-center">
        <div className="flex justify-wrap mt-1">
          <Link href="/travel">
            <a className="text-2xl mr-2 text-pink-600">
            Travel Piks
            </a>
          </Link>
        </div>
