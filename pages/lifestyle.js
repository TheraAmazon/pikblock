...
import {
  ...
  pikblocklifestyleMarketaddress,
} from '../config';
...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    const tokenContract = new ethers.Contract(
      pikblocklifestyleaddress,
      PIKBLOCKLIFESTYLE.abi,
      provider
    );
    const marketContract = new ethers.Contract(
      pikblocklifestyleMarketaddress,
      PIKBLOCKLIFESTYLEMarket.abi,
      provider
    );
  ...
  async function buyNft(pikblocklifestyle) {
    ...
    const price = ethers.utils.parseUnits(
      pikblocklifestyle.price.toString(),
      'ether'
    );
    const transaction = await contract.createMarketSale(
      pikblocklifestyleddress,
      pikblocklifestyle.itemId,
      {
        value: price,
      }
    );
