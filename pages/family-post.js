...
export default function CreateItem() {
  ...
  async function createSale(url) {
    ...
    let contract = new ethers.Contract(pikblockfamilyaddress, PIKBLOCKFAMILY.abi, signer)
    ...
    contract = new ethers.Contract(pikblockfamilyMarketaddress, PIKBLOCKFAMILYMarket.abi, signer)
    let listingPrice = await contract.getListingPrice()
    listingPrice = listingPrice.toString()

    transaction = await contract.createMarketItem(pikblockfamilyaddress, tokenId, price, { value: listingPrice })
