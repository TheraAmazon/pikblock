...
export default function CreateItem() {
  ...
  async function createSale(url) {
    ...
    let contract = new ethers.Contract(pikblocktraveladdress, PIKBLOCKTRAVEL.abi, signer)
    ...
    contract = new ethers.Contract(pikblocktravelMarketaddress, PIKBLOCKTRAVELMarket.abi, signer)
    let listingPrice = await contract.getListingPrice()
    listingPrice = listingPrice.toString()

    transaction = await contract.createMarketItem(pikblocktraveladdress, tokenId, price, { value: listingPrice })
