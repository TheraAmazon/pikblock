...
import { pikblockaddress } from '../config';
      ...
      <div className="Faucet">
        ...
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-yellow-700 flex justify-center">
            Each pik is sent to the interplanetary file system and hosted
            forever!
          </h4>
        </p>
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-yellow-400 flex justify-center">
            Piks are listed for sale, and users will automatically receive on
            sale!
          </h4>
        </p>
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-green-400 flex justify-center">
            The rules still apply to regulations of copyright, stealing others
            pictures is a crime!
          </h4>
        </p>
        <p>
        ...
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-blue-600 flex justify-center">
            To participate just ask for free Pikblock tokens and receive your
            Crypto
          </h4>
        </p>
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-indigo-600 flex justify-center">
            The Faucet resets every 45 minutes! Come back hourly to receive
            more!
          </h4>
        </p>
        <p>
          <h4 className="text-3xl font-normal leading-normal mt-0 mb-2 text-purple-600 flex justify-center">
            Watch the tutorial and participate on our Discord through the
            following Link for airdrops!
          </h4>
        </p>

        <header className="Faucet-header flex justify-center">
          <button
            onClick={WinPiktokens}
            className="text-yellow-500 bg-transparent border border-solid border-yellow-500 hover:bg-yellow-500 hover:text-white active:bg-blue-600 font-bold uppercase px-1 py-7 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button"
          >
            Receive Free PikBlock Crypto!
          </button>
        </header>

        <header className="Faucet-header flex justify-center">
          <button
            className="text-blue-500 bg-transparent border border-solid border-blue-500 hover:bg-blue-500 hover:text-white active:bg-blue-600 font-bold uppercase px-4 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button"
          >
            <Link href="https://discord.gg/myeSk52J6x">
              <a className="px-10 py-4 text-1xl flex justify-center rounded">
                Pikblock Discord!
              </a>
            </Link>
          </button>
