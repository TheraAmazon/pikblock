    ...
    <div className="max-w-md mx-auto">
      <div className="divide-y divide-gray-200">
        <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
          <p>By signing in and posting your art:</p>
          <ul className="list-disc space-y-2">
            <li className="flex items-start">
              ...
              <p className="ml-2">
              You permit the The arts musuem and Thera to 
                <code className="text-sm font-bold text-gray-900"> utilize</code> your art
              </p>
            </li>
            <li className="flex items-start">
              <span className="h-6 flex items-center sm:h-7">
              ...
              <p className="ml-2">
                You will respect the users, artists,
                <code className="text-sm font-bold text-gray-900"> censorship and copyright</code>
              </p>
            </li>
            <li className="flex items-start">
              <span className="h-6 flex items-center sm:h-7">
              ...
              <p className="ml-2">If you post porn, pedophile or anything disturping you will be permanently banned</p>
            </li>
            <li className="flex items-start">
              <span className="h-6 flex items-center sm:h-7">
                <svg className="flex-shrink-0 h-5 w-5 text-cyan-500" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="ml-2">You will help humanity evolve through art, love and beauty</p>
            </li>
          </ul>
