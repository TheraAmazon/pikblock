...
export default function CreateItem() {
  ...
  async function createSale(url) {
    ...
    let contract = new ethers.Contract(pikblocklifestyleaddress, PIKBLOCKLIFESTYLE.abi, signer)
    ...
    contract = new ethers.Contract(pikblocklifestyleMarketaddress, PIKBLOCKLIFESTYLEMarket.abi, signer)
    let listingPrice = await contract.getListingPrice()
    listingPrice = listingPrice.toString()

    transaction = await contract.createMarketItem(pikblocklifestyleaddress, tokenId, price, { value: listingPrice })
